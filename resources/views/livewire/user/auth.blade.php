                                    ...
                                    <form class="mb-3" wire:submit="login">
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check form-label text-body">
                                                <input class="form-check-input" type="checkbox" name="remember" wire:model="remember">
                                        ...
                                        <div class="mb-3" wire:ignore>
                                            ...
                                            <input type="hidden"
                                                   id="login-g-recaptcha-response"
                                                   wire:model="gRecaptchaResponse">
                                        </div>
                                        ...
                                        <button
                                                class="btn btn-primary d-flex align-items-center justify-content-center w-100 waves-effect waves-light"
                                                type="submit"
                                                id="loginBtn"
                                    ...
                                    <a href="{{ route('auth.google') }}"
                                       class="btn btn-dark d-flex align-items-center justify-content-center w-100 waves-effect waves-light">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                             viewBox="0 0 28 28"
                                             fill="none">
                                            <g clip-path="url(#clip0_436_15312_2)">
                                                <path
                                                        d="M6.20539 16.9208L5.23075 20.5592L1.66846 20.6346C0.603859 18.66 0 16.4008 0 14C0 11.6785 0.564594 9.48921 1.56537 7.56153L4.73758 8.14297L6.12686 11.2954C5.83609 12.1431 5.6776 13.0531 5.6776 14C5.67771 15.0277 5.86387 16.0123 6.20539 16.9208Z"
                                                        fill="#FFC700"/>
                                                <path
                    ...
                    <form wire:submit.prevent="forgetPassword">
                        ...
                        <button type="submit"
                            ...
                            <span wire:loading wire:target="forgetPassword"
                                  class="spinner-border spinner-border-sm me-2" role="status"
                                  aria-hidden="true"></span>
                            <span wire:loading.remove wire:target="forgetPassword">Continue</span>
                ...
                <div class="modal-body p-4">
                    <form wire:submit.prevent="resetPassword">
                        ...
                        <div class="d-flex gap-2 mt-4">
                            <button type="submit"
                                    class="btn btn-primary d-flex align-items-center justify-content-center w-50 waves-effect waves-light"
                                    wire:loading.attr="disabled">
                                <span wire:loading wire:target="resetPassword"
                                      class="spinner-border spinner-border-sm me-2" role="status"
                                      aria-hidden="true"></span>
                                <span wire:loading.remove wire:target="resetPassword">Continue</span>
                                <span wire:loading wire:target="resetPassword">Resetting...</span>
                            </button>

                            <a href="{{ route('home') }}"
                               class="btn btn-danger d-flex align-items-center justify-content-center w-50 waves-effect waves-light">
                                Close
                            </a>
                        </div>
                    </form>
...
<script>
    ...
    document.getElementById('authModal').addEventListener('show.bs.modal', function (event) {
        ...
        if (button && button.getAttribute('data-signup') === 'true') {
